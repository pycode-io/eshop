                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="order-details">
                            ...
                            <input hidden name="rzp_paymentid" id="rzp_paymentid" />
                            <input hidden name="payment_gateway" />
                            ...
                            <div class="single-widget get-button">
                                <div class="content">
                                    <div class="button">
                                        <button type="submit" class="btn" id="proceed_to_checkout">proceed to
                                            checkout</button>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function calculateAmountInPaise() {
            // Your code to calculate the total amount in paise
            // For example:
        ...
        document.getElementById('proceed_to_checkout').addEventListener('click', function(e) {
            e.preventDefault();

            // Replace 'RAZORPAY_KEY' with your actual Razorpay key obtained from the dashboard
            var razorpayKey = "{{ env('RAZORPAY_KEY') }}";
            var options = {
                key: razorpayKey,
                amount: calculateAmountInPaise(), // Function to calculate the amount in paise
                currency: 'INR',
                name: 'ESHOP',
                description: 'Purchase Description',
                handler: function(response) {
                    // After successful payment, submit the form with the Razorpay payment ID
