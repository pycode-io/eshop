...
// Email Api routes
Route::get('/varify-mail/{token}', [UserController::class, 'varification_mail']);
Route::get('/reset-password', [UserController::class, 'reset_password_view']);
Route::post('/reset-password', [UserController::class, 'reselt_password_update'])->name('reset_password');
