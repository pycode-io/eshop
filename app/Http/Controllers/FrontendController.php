...
class FrontendController extends Controller
{
    ...
    public function productGrids()
    {
        ...
        if (!empty($_GET['show'])) {
            ...
            $products = $products->where('status', 'active')->simplePaginate(9);
        }
    ...
    public function productLists()
    {
        ...
        // Sort by number
        if (!empty($_GET['show'])) {
            $products = $products->where('status', 'active')->simplePaginate($_GET['show']);
        } else {
            $products = $products->where('status', 'active')->simplePaginate(6);
        }
        // Sort by name , price, category
